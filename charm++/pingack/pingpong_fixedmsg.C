...
#include "pingpong_fixedmsg.decl.h"
...
public:
  ...
  void print_results() {
    ...
    CkPrintf("DATA,%d,%d,%f,%f,%f,%f,%f,%f,%f,%f,%f\n", CkNumPes(), BIGMSG_SIZE, get_average(send_time), get_average(process_time), get_average(total_time),
...
#include "pingpong_fixedmsg.def.h"
